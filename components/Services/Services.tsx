...
const Services = () => {
  ...
  return (
    <section
      ...
      className="w-full container-max bg-white max-sm:pt-[100px]  pb-[120px] max-lg:pb-[62px] max-md:pb-[42px] max-sm:pb-[32px]"
    >
      <div className="min-h-screen">
        <div
          className={`flex pt-[50px] max-lg:pt-[100px] justify-start  pb-[80px]  flex-col gap-[100px] items-center max-lg:gap-[500px]  ${
            language === "ar"
              ? "max-sm:gap-[400px]  max-sm:pt-[20px]"
              : "max-sm:gap-[600px]  max-sm:pt-[100px]"
          }  items-center`}
        >
          <ServiceCard
            title={`${
